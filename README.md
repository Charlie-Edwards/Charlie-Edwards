...
**Web:** I bought my first website at **13 years old**, learning about SSL, requests, servers and security like IP rate limiting with Cloudflare turnstiles and defend against simulated attacks.
